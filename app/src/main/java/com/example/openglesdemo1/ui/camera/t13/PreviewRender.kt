...
class PreviewRender(val renderName: String) {
    ...
    fun initEgl(sv: Surface, sharedContext: EGLContext) {
        ...
        val vertexId =
            ShaderUtils.compileVertexShader(ResReadUtils.readResource(R.raw.camera2_t13_vertex2))
        val fragmentId =
            ShaderUtils.compileFragmentShader(ResReadUtils.readResource(R.raw.camera2_t13_fragment2))
