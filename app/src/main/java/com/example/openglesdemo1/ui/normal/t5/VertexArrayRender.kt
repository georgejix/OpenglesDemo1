...
class VertexArrayRender : GLSurfaceView.Renderer {
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        //编译
        val vertexShaderId =
            ShaderUtils.compileVertexShader(ResReadUtils.readResource(R.raw.normal_t5_vertex_array_shader))
        val fragmentShaderId =
            ShaderUtils.compileFragmentShader(ResReadUtils.readResource(R.raw.normal_t5_fragment_array_shader))
        //鏈接程序片段
