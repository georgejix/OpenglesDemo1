...
class TextureRender : GLSurfaceView.Renderer {
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        var vertexShader =
            ShaderUtils.compileVertexShader(ResReadUtils.readResource(R.raw.normal_t8_vertex_texture_shader))
        var fragmentShader =
            ShaderUtils.compileFragmentShader(ResReadUtils.readResource(R.raw.normal_t8_fragment_texture_shader))
