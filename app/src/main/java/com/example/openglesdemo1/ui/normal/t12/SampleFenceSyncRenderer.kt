...
class SampleFenceSyncRenderer(val imageView: ImageView) : GLSurfaceView.Renderer {
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        GLES30.glDrawArrays(
            GLES30.GL_TRIANGLES,
            0,
            textureCoordinateData.size / VERTEX_COMPONENT_COUNT
        )
        ...
        otherThreadHandler.post {
            if (!flag) {
                ...
                val buffer =
                    ByteBuffer.wrap(ByteArray(glSurfaceViewWidth * glSurfaceViewHeight * 4))
                GLES30.glReadPixels(
                    0,
                    0,
                    glSurfaceViewWidth,
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        otherThreadHandler.post {
            ...
            val pBufferSurface =
                EGL14.eglCreatePbufferSurface(eglDisplay, eglConfig[0], attribList, 0)
