...
class VertexBufferRender : GLSurfaceView.Renderer {
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        //编译
        val vertexShaderId =
            ShaderUtils.compileVertexShader(ResReadUtils.readResource(R.raw.normal_t4_vertex_buffer_shader))
        val fragmentShaderId =
            ShaderUtils.compileFragmentShader(ResReadUtils.readResource(R.raw.normal_t4_fragment_buffer_shader))
        //鏈接程序片段
